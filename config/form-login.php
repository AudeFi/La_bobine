...
// ----------- INSCRIPTION -------------
	...
	{	
			...
			else
			{
				...
				$message = 'Merci de vous être inscrit sur La Bobine. Vous pouvez désormais contribuer au site en y ajoutant des musiques. Si vous faites preuve de bonne utilisation, vous pourrez peut être même être séléctionné pour modérer les propositions d\'autres utilisateurs<\n> Votre pseudo est '.$pseudo.'. Seul vous connaissez votre mot de passe.<\n> L\'équipe La Bobine';
